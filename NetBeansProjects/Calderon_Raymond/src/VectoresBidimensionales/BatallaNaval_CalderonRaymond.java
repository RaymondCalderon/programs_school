...
class BatallaNaval_CalderonRaymond {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (("-".equals(tablero[fila - 1][columna - 1]))) {
                ...
                fallos++;
            } else if ("F".equals(tablero[fila - 1][columna - 1])) {
                System.out.println("Aqui ya buscaste flojo");
                fallos++;
            } else {
        ...
        System.out.println("Has destruido todas las Naves del Enemigo");
